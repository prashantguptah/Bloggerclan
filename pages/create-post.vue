<template>
  <div class="h-[95vh] bg-gray-100 text-gray-900 flex justify-center items-center">
    <div class="w-[70vw] bg-white p-8 rounded-xl shadow-lg w-[45rem] border border-gray-300">
      ...
      <textarea
        ...
        class="w-full h-[30vh] bg-gray-100 text-gray-900 p-3 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-300 outline-none resize-none mb-4"
      ></textarea>
